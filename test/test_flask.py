...
def flask_workspace():
    ...
    yield flask_workspace
    flask_workspace.exit()


class TestFlaskWorkspace:

    # def test_x_packages(self, flask_workspace):
    ...
    def test_local_hover(self, flask_workspace):
        desired_result = {
            'contents': [
                {
                    'language': 'python',
    ...
    def test_cross_module_hover(self, flask_workspace):
    ...
    def test_cross_package_hover(self, flask_workspace):
    ...
    # def test_cross_repo_definition(self, flask_workspace):
    ...
    # def test_cross_repo_import_definition(self, flask_workspace):
    ...
    def test_stdlib_hover(self, flask_workspace):
    ...
    # def test_stdlib_definition(self, flask_workspace):
    ...
    # def test_local_references(self, flask_workspace):
    ...
    # def test_x_references(self, flask_workspace):
    ...
    # def test_definition_of_definition(self, flask_workspace):
