...
import (
	...
	"github.com/sourcegraph/langserver-python/python"
)
...
var (
	...
	logfile  = flag.String("log", "/tmp/langserver-python.log", "write log output to this file (and stderr)")
)
...
func run() error {
	...
	h := jsonrpc2.HandlerWithError((&python.Handler{}).Handle)
